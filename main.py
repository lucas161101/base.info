...
def crear_tabla():
    ...
    try:
        ...
        print("La tabla ha sido creada de manera exitosa")
...
def eliminar_tabla():
    ...
    try:
        cursor.execute(query)
        print("La tabla ha sido eliminada de manera exitosa")
    except psycopg2.Error as e:
        print(f"Ocurrio un error al eliminar la tabla: {e}")
    cursor.close()
...
def actualizar_datos():
    ...
    try:
        ...
        connection.rollback()
        print(f"Ocurrio un error al actualizar el dato: {e}")
    cursor.close()
